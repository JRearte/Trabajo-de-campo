...
--
-- Dumping routines for database 'jardin'
--
...
BEGIN
INSERT INTO usuario(legajo,nombre,apellido,categoria,contrasenia) VALUES (legajo,nombre,apellido,categoria,contrasenia);
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `eliminarUsuario`(id int)
BEGIN
...
-- Dump completed on 2023-07-05  5:40:25

...
CREATE TABLE `discapacidad` (
  ...
  UNIQUE KEY `id_discapacidad_UNIQUE` (`id_discapacidad`),
  KEY `fk_discapacidad_niño1_idx` (`id_niño`),
  CONSTRAINT `fk_discapacidad_niño1` FOREIGN KEY (`id_niño`) REFERENCES `niño` (`id_niño`)
...
-- Dump completed on 2023-07-05  5:43:56
